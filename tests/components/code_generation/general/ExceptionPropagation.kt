...
internal class ExceptionPropagation {
	...
	// -X exception doesn't match, always block runs and exception is propagated
	...
	@Test
	fun `always block is executed and execution is resumed after handle block didn't run`() {
		val sourceCode = """
			SomeError class
			OtherError class
			SimplestApp object {
