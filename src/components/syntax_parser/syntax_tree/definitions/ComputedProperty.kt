...
import components.semantic_analysis.semantic_model.definitions.ComputedProperty as SemanticComputedPropertyModel
...
class ComputedProperty(private val identifier: Identifier, private val type: TypeElement?,
	...
	override fun concretize(linter: Linter, scope: MutableScope): SemanticComputedPropertyModel {
		...
		val computedProperty = SemanticComputedPropertyModel(this, identifier.getValue(),
