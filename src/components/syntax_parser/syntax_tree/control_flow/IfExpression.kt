...
class IfExpression(private val condition: ValueSyntaxTreeNode, private val positiveBranch: StatementSection,
				   private val negativeBranch: StatementSection?, val isPartOfExpression: Boolean, start: Position, end: Position):
