...
object PrimitiveIntNatives {
	...
	private fun compileToThePowerOf(constructor: LlvmConstructor): PrimitiveImplementation {
		...
		val function = constructor.buildFunction("Int.toToPowerOf(Int): Int", functionType)
...
//			val condition = constructor.buildCastFromIntegerToBoolean(exponent, "condition")
...
//			val condition = constructor.buildCastFromIntegerToBoolean(mostInsignificantBit, "condition")
...
//		val result = constructor.buildLoad(constructor.i32Type, resultVariable, "result")
		...
		constructor.buildReturn(thisInt) //TODO revert
