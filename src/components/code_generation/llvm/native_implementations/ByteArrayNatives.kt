...
class ByteArrayNatives(val context: Context) {
	...
	private fun concatenate(model: SemanticModel, constructor: LlvmConstructor, llvmFunctionValue: LlvmValue) {
		...
		constructor.buildFunctionCall(context.externalFunctions.memoryCopy, listOf(combinedValue, thisArrayValue, thisSizeAsSizeType))
		...
		constructor.buildFunctionCall(context.externalFunctions.memoryCopy,
			listOf(offsetCombinedArrayAddress, parameterValue, parameterSizeAsSizeType))
